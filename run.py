...
if __name__ == '__main__':
    ...
    parser.add_argument('--loss', type=str, default='MSE',
                        choices=['MSE', 'TALoss', 'mse', 'mseloss', 'taloss', 'ta_loss'],
                        help='loss function, options: [MSE, TALoss]')
    parser.add_argument('--taloss_lambda', type=float, default=0.5,
                        help='lambda weight for TALoss trend-alignment penalty')
    parser.add_argument('--taloss_eps', type=float, default=1e-8,
                        help='epsilon for numerical stability in TALoss')
